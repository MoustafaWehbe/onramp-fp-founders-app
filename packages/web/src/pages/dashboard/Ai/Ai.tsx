...
export function Ai() {
  ...
  const createSessionMutation = useMutation({
    mutationFn: (initialPrompt?: string) => createAiSession(startupId, { contextMode: "selected", documentVersionIds: selectedVersionIds, ...(roundId ? { roundId } : {}) }),
