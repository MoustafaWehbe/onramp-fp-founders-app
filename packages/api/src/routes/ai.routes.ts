...
router.post("/analyses", authenticate, validate(startupIdParamSchema, "params"), requireMember, requirePermission("ai_reports", "create"), requirePermission("documents", "read"), validate(createAiAnalysisSchema), aiController.createAnalysis);
