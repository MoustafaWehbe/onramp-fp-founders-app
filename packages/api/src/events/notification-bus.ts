/**
 * Fan-out for live notification events.
 *
 ...
 * NotificationBus and changing the export at the bottom of this file; nothing
 ...
 */
class InProcessNotificationBus implements NotificationBus {
...
export const notificationBus: NotificationBus = new InProcessNotificationBus();
